...
const HomeHeaders: React.FC<IHeaders> = ({  thumbnail, name,role,totalNotification }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.detail}>
        <Text style={{color:"#FFFF"}}>Halo, Selamat Datang {name}</Text>
        <Text style={{color:"#FFFF", fontWeight:600}}>{role}</Text>
      </View>
